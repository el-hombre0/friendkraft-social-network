        ...
        default:
            ...
            while ($r = pg_fetch_array($q)) {
                ...
                while ($r_1 = pg_fetch_array($q_1)) {
                    ...
                    echo "<div id=zayavka><div id=act><p><img src=" . $r_1['avatar'] . " ><b><a href=/index?id=" . $r_1['id'] . ">" . $r_1['name'] . "&nbsp;&nbsp;" . $r_1['lastname'] . "</a><br>Отправила заявку на
             добавление в друзья</font></b></p><br><br><br><code><a href=friends?drug=prin&id=" . $r['id'] . ">Принять</a>&nbsp;&nbsp;<a href=friends?drug=show&id=" . $r['id'] . ">Отклонить</a></code></div></div>";
                }
            }
            echo "<br>";
